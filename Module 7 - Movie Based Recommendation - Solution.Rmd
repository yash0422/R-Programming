...
getwd()
setwd("C:/Users/Asus/Desktop/Data Science Master Program/Edureka_Studies/R Certification/007 RECOMMENDATION ENGINES")
...
recom = predict(recommender_model, ra_tng_mtrx[100], n = 5) # Obtain top 5 recommendations for 1st user in dataset
recom
...
recom2 = predict(recommender_model, ra_tng_mtrx[101], n = 5) # Obtain top 5 recommendations for 2nd user in dataset
recom2
recom_list2 = as(recom2, "list")                             # convert recommenderlab object to readable list
recom_list2

# Obtain Recommendations
recom_result2 = matrix(0,5)
for (i in 1:5){
